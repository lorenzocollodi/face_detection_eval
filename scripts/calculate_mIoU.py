from utils.eval_utils import getmIoU
from utils.read_utils import read_file_key
...
if __name__ == "__main__":
    for key, file_gt in keys:
        file_gt = f"Annotation/{file_gt}.txt"
        for model in models:
            file_pred = f"Predictions/{model}_predictions.txt"
